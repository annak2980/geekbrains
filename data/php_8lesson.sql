...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Сен 02 2018 г., 14:02
...
(4, 'Ноутбук Леново', 40000, '7.jpg', '7.jpg', '444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444'),
(13, 'Фотообои космические', 200, '2.jpg', '2_big.jpg', '22222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222');
...
(1, 'admin', 'admin', '112233', '2018-09-02 10:58:54', 1, 'test@test.com', '0000-00-00 00:00:00'),
(2, 'user', 'user', '112233', '2018-09-02 10:58:19', 2, 'test@test.ru', '0000-00-00 00:00:00'),
(10, 'user5', 'user5', '112233', '2018-08-29 11:03:19', 2, 'annak2980@gmail.com', '2018-08-29 08:59:15'),
(12, 'user6', 'user6', '112233', '0000-00-00 00:00:00', NULL, 'annak2980@gmail.com', '2018-08-29 10:57:18');
...
--
ALTER TABLE `basket`
  MODIFY `id_basket` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=132;

--
-- AUTO_INCREMENT для таблицы `discounts`
--
ALTER TABLE `discounts`
  MODIFY `id_discount` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT для таблицы `goods`
--
ALTER TABLE `goods`
  MODIFY `id_good` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT для таблицы `guestbook`
--
ALTER TABLE `guestbook`
  MODIFY `id_record` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
